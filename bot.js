...
client.on('message', msg => {  //WESO#0001
    if (msg.content === '.') {  //WESO#0001
      msg.reply('***منور سيرفرنا يا اخ يرجى انك تتفاعل***');  //WESO#0001
    }
  });
...
const devs = ["623515984652927011","604418185340518457"]
...
client.login('NjI3MjQwMzU5MzUyNzI5NjQx.XY5xIQ.Q8XIFn8miWZEmbdFKgJBGnMONXs');
